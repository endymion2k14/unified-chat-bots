...
export class ClientTwitch extends EventEmitter {
    constructor(settingsJSON) {
        ...
        this.sendMessage = function(message) { if (!this.chat_silence) { sleep(this.chat_delay); this._backend.say(message).catch(err => { log.error(err, `${SOURCE}-${this._settings.name}`); }); } }
